...
module.exports = class TicTacToe {
    ...
    async TTTGame() {
        ...
        .addFields([{ name: (this.options.statusTitle || 'Status'), 
            value: this.options.turnMessage.replace('{emoji}', this.getChip()).replace('{player}', this.xTurn ? this.message.author.tag : this.opponent.tag)
	...
	gameOver(result, msg) {
        ...
        .setTitle(`${this.message.author.username} vs ${this.opponent.username}`)
        .addFields([{ name: this.options.embed.overTitle, value: this.getResultText(result) }])
