...
module.exports = class EightBall {
	...
	startGame() {
		...
		.addFields([{ name: 'Question', value: this.options.question, inline: false }])
		.addFields([{ name: 'Answer', value: answers[Math.floor(Math.random() * answers.length)], inline: false }])
		.setFooter({ text: this.message.author.tag, value: this.message.author.displayAvatarURL({ dynamic: true })})
