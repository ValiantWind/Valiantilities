...
module.exports = class TwoZeroFourEight {
    ...
    getImage() {
        return new MessageAttachment(`https://api.aniket091.xyz/2048?board=${this.gameBoard.map(c => chars[c]).join('')}`, 'gameboard.png')
    }
    ...
    async gameOver(msg) {
        ...
        .setTitle(this.options.embed.title)
        .setImage('attachment://gameboard.png')
        .addFields([{ name: overTitle, value: (this.options.embed.totalScore || '**Score:** ') + this.score.toString() }])
        .setFooter({ text: this.message.author.tag, iconURL: this.message.author.displayAvatarURL({ dynamic: true }) })
